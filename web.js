...
var ASM_CONSTS = {
 ...
 305824: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 305907: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 305976: () => { return window.innerWidth; },  
 306006: () => { return window.innerHeight; }
};
